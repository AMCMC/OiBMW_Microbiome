...
names(seqs) <- c(asvrefdist$name,mockrefdist$name)
...
fitGTR$tree$tip.label <- gsub("Bifidobacterium ","B.",fitGTR$tree$tip.label) 
fitGTR$tree$tip.label <- gsub("Parascardovia ","P.",fitGTR$tree$tip.label) 
fitGTR$tree$tip.label <- gsub("Alloscardovia ","A.",fitGTR$tree$tip.label) 

groupInfo <- rep("Silva",length(fitGTR$tree$tip.label))
groupInfo[fitGTR$tree$tip.label %in% asvrefdist[asvrefdist$dist>=5,]$name] <- "Xeno_ASV"
groupInfo[fitGTR$tree$tip.label %in% asvrefdist[asvrefdist$dist<5,]$name] <- "Valid_ASV"
